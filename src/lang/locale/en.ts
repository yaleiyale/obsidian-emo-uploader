...
export default {
 ...
 If your note will be used for publicity, please remember to delete it in time.`,
  ...
  imgurid: 'id',
  'built-in id desc': 'The built-in ID has a daily usage limit, if it is temporarily invalid, you can use your own client ID to upload and delete.',
  delete: 'delete',
  ...
  'auth desc': 'Sometimes the auth results need to be refreshed manually before they are displayed.',
